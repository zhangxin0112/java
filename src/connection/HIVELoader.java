...
public class HIVELoader {
	private static String url = 
			"jdbc:hive2://192.168.0.11:10000/default;autho=NOSASL";
	private static String username ="hive";
	private static String pwd="hive";
	private static String drivername ="org.apache.hive.jdbc.HiveDriver";
	private static String sql = "select * from test_zx limit 10";
	...
	public void exehive(String url,
			String username,String pwd,String drivername,String sql) 
